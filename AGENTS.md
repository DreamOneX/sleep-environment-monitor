...
- [docs/20-server/00-overview.md](docs/20-server/00-overview.md): measurement ingestion server role and current temporary receiver.
- [docs/20-server/01-rest-api.md](docs/20-server/01-rest-api.md): planned REST API contract between firmware and server.

...
def test_check_config_prints_valid_config() -> None:
    stream = StringIO()
...
def test_check_config_rejects_empty_host() -> None:
...
def test_print_discovery_plain_output() -> None:
    stream = StringIO()
...
def test_print_discovery_json_output() -> None:
    stream = StringIO()
...
def test_print_discovery_rich_output_is_callable() -> None:
    stream = StringIO()
